...
export class EntityPicker {
  ...
  constructor(public navParams: NavParams, public viewCtrl: ViewController, public stories: Stories, public categories: Categories) {
    ...
    this.input$
      ...
      .switchMap(q => {
        ...
        this.loading = true;
        return this.kind === 'series' ? this.stories.searchSeries(trimmed) : this.stories.searchAuthors(trimmed);
      })
